  ...
  return (
    <>
      <div className="bg-primary">
        ...
        <section className="section2 calc-vh-100 bg-white">
          <div
          ...
          >
            <div className="col-md-6 d-flex flex-column mt-5 pt-5">
              <h1 className=" fw-bold mt-5">
                Ganhe Dinheiro Extra Com Seu Carro
              </h1>
              <h3 className="fw-semibold">
                Transforme seu carro em uma fonte de renda
              </h3>
              <h5 className="fw-regular">
                Alugue quando não estiver usando e aproveite para ganhar
                enquanto compartilha com quem precisa
              </h5>
